...
import com.example.book_app.filter.FilterCategory;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> implements Filterable {
    ...
    public ArrayList<CategoryModel> categoryModelArrayList, filterList;
    ...
    public CategoryAdapter(Context context, ArrayList<CategoryModel> categoryModelArrayList) {
        ...
        this.filterList = categoryModelArrayList;
    }
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.ViewHolder holder, int position) {
       ...
       holder.itemView.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               Intent intent = new Intent(context, PdfAdminListActivity.class);
    ...
    private void deleteCategory(CategoryModel model, ViewHolder holder) {
        String id = model.getId();
